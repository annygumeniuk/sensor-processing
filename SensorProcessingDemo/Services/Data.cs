...
namespace SensorProcessingDemo.Services
{
    public class Data
    {
        ...
        { 
            ...
            new Sensor() { Id = 7, Name = "Temperature", Value = 22m,   dateTime = DateTime.ParseExact("2024-11-12-11-30-20", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},
            ...
            new Sensor() { Id = 8, Name = "Humidity", Value = 44m, dateTime = DateTime.ParseExact("2024-11-12-11-30-20", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},
            ...
            new Sensor() { Id = 9, Name = "Lighting", Value = 350m, dateTime = DateTime.ParseExact("2024-11-12-11-30-20", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},
        };
    }
}
