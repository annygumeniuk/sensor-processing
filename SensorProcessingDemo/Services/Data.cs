...
namespace SensorProcessingDemo.Services
{
    public class Data
    {
        ...
        { 
            ...
            new Sensor() { Id = 2, Name = "Humidity", Value = 55m, dateTime = DateTime.ParseExact("2024-11-12-10-30-20", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},

            new Sensor() { Id = 3, Name = "Lighting", Value = 500m, dateTime = DateTime.ParseExact("2024-11-12-08-30-45", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},
            new Sensor() { Id = 2, Name = "Lighting", Value = 400m, dateTime = DateTime.ParseExact("2024-11-12-10-30-20", "yyyy-MM-dd-HH-mm-ss", CultureInfo.InvariantCulture)},
        };
    }
}
